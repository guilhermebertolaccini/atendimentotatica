...
const menuItems: MenuItem[] = [
  {
    ...
    icon: Headphones,
    color: "text-cyan",
    roles: ["operador", "admin", "agente"], // Agentes têm acesso
  },
  {
    title: "Supervisionar",
    url: "/supervisionar",
    icon: Eye,
    color: "text-warning",
    roles: ["supervisor", "admin", "digital"], // Agentes NÃO têm acesso
  },
  {
    title: "Contatos",
    url: "/contatos",
    icon: BookUser,
    color: "text-cyan",
    roles: ["supervisor", "admin", "digital", "agente"], // Agentes têm acesso
  },
  {
    title: "Campanhas",
    url: "/campanhas",
    icon: Megaphone,
    color: "text-primary",
    roles: ["supervisor", "admin", "digital", "agente"], // Agentes têm acesso (leitura/envio)
  },
  {
    title: "Tabulações",
    url: "/tabulacoes",
    icon: Table2,
    color: "text-whatsapp",
    roles: ["supervisor", "admin", "digital"], // Agentes NÃO têm acesso (gerenciamento)
  },
  {
    title: "Segmentos",
    url: "/segmentos",
    ...
    roles: ["admin"], // Agentes NÃO têm acesso
  },
  {
    title: "Blocklist",
    url: "/blocklist",
  ...
  },
  {
    ...
    icon: BarChart3,
    color: "text-success",
    roles: ["supervisor", "admin", "digital"], // Agentes NÃO têm acesso (relatórios avançados)
  },
  {
  ...
  },
  {
    ...
    icon: Phone,
    color: "text-whatsapp",
    roles: ["admin", "ativador"], // Agentes NÃO têm acesso
  },
  {
    title: "Usuários",
    url: "/usuarios",
